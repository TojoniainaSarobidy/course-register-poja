package course.register.demo.endpoint.event.consumer;

import static java.util.stream.Collectors.toList;

import course.register.demo.PojaGenerated;
import course.register.demo.concurrency.Workers;
import course.register.demo.endpoint.event.consumer.model.ConsumableEvent;
